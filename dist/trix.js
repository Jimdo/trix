...
(function() {
  ...
  (function() {
    ...
    (function() {
      ...
      Trix.extend({
        ...
        getBlockTagNames: function() {
          var blockTagNames, key, value;
          blockTagNames = (function() {
            var ref3, results;
          ...
          blockTagNames = blockTagNames.filter(function(item) {
            return !!item;
          });
          return Trix.blockTagNames != null ? Trix.blockTagNames : Trix.blockTagNames = blockTagNames;
        },
    ...
    (function() {
      var insertStyleElementForTagName, installDefaultCSSForTagName, registerElement, rewriteFunctionsAsValues, rewriteLifecycleCallbacks;
    ...
    (function() {
      ...
      Trix.config.blockAttributes = attributes = {
        ...
        alignRight: {
          ...
          test: function(element) {
            var ref;
            return ((ref = element.className) != null ? ref.indexOf("text-align-right") : void 0) !== -1;
          }
        },
        alignCenter: {
          inheritFromPreviousBlock: true,
          ...
          test: function(element) {
            var ref;
            return ((ref = element.className) != null ? ref.indexOf("text-align-center") : void 0) !== -1;
          }
        }
      };
    ...
    (function() {
      ...
      Trix.CompositionInput = (function(superClass) {
        ...
        function CompositionInput(inputController) {
          ...
          this.reparse = bind(this.reparse, this);
        ...
        CompositionInput.prototype.reparse = function() {
          return this.inputController.delegate.reparse();
        };

        CompositionInput.prototype.end = function(data) {
          this.data.end = data;
          if (this.isSignificant() && this.canApplyToDocument) {
            return setTimeout(this.reparse, 1);
          }
        };
    ...
    (function() {
      var dataTransferIsPlainText, dataTransferIsWritable, extensionForFile, handleEvent, hasStringCodePointAt, innerElementIsActive, keyEventIsKeyboardCommand, keyEventIsPasteAndMatchStyleShortcut, keyEventIsWebInspectorShortcut, keyNames, makeElement, objectsAreEqual, pasteEventIsCrippledSafariHTMLPaste, stringFromKeyEvent, tagName, testTransferData,
        extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
        hasProp = {}.hasOwnProperty,
        indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; };
      ...
      Trix.InputController = (function(superClass) {
        ...
        InputController.keyNames = keyNames;
        ...
        InputController.prototype.events = {
          ...
          paste: function(event) {
            var clipboard, extension, file, href, html, name, paste, ref, ref1, ref10, ref11, ref12, ref13, ref14, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, selection;
            ...
            if (href = clipboard.getData("URL")) {
              ...
              if (this.selectionIsExpanded()) {
                selection = this.delegate.editor.getSelectedRange();
                this.delegate.editor.deleteInDirection("backward");
                this.delegate.editor.setSelectedRange(selection[0]);
              }
    ...
    (function() {
      ...
      Trix.PieceView = (function(superClass) {
        ...
        PieceView.prototype.createContainerElement = function() {
          var attributes, config, key, lastGroupTagName, ref, value;
          attributes = null;
    ...
    (function() {
      ...
      Trix.BlockView = (function(superClass) {
        ...
        BlockView.prototype.createNodes = function() {
          var attr, attribute, attributes, blacklist, className, classNames, comment, element, i, j, len, len1, node, nodes, ref, ref1, ref2, textConfig, textView;
          ...
          attributes = (function() {
            ...
            for (i = 0, len = ref1.length; i < len; i++) {
              attr = ref1[i];
              if (indexOf.call(blacklist, attr) < 0) {
                results.push(attr);
              }
            }
            return results;
          ...
          if (attributes.length) {
            ...
            for (i = 0, len = ref1.length; i < len; i++) {
              attribute = ref1[i];
              if (className = (ref2 = Trix.getBlockConfig(attribute)) != null ? ref2.className : void 0) {
        ...
        BlockView.prototype.createContainerElement = function(depth) {
          var attr, attribute, className, classNames, config, element, i, j, len, len1, ref, ref1, ref2;
          attribute = void 0;
          config = void 0;
          ref = this.attributes.slice(depth);
          for (i = 0, len = ref.length; i < len; i++) {
            attr = ref[i];
            if (attr) {
    ...
    (function() {
      ...
      Trix.Block = (function(superClass) {
        ...
        Block.prototype.addAttribute = function(attribute) {
          var attr, attributes, filteredAttributes, i, len, ref, role;
          role = Trix.getBlockConfig(attribute).role;
          if (role != null) {
            filteredAttributes = [];
            ref = this.attributes;
            for (i = 0, len = ref.length; i < len; i++) {
              attr = ref[i];
              if (Trix.getBlockConfig(attr).role !== role) {
        ...
        Block.prototype.getLastAttribute = function() {
          var significantAttrs;
          significantAttrs = this.getSignificantAttributes();
          return getLastElement(significantAttrs);
        };

        Block.prototype.getSignificantAttributes = function() {
          var insignificantAttributes;
          insignificantAttributes = ["alignCenter", "alignRight"];
          return this.getAttributes().filter(function(attr) {
            return indexOf.call(insignificantAttributes, attr) < 0;
          });
        };
        ...
        Block.prototype.getAttributeLevel = function() {
          var significantAttrs;
          significantAttrs = this.getSignificantAttributes();
          return significantAttrs.length;
        };
        ...
        Block.prototype.hasSignificantAttributes = function() {
          var significantAttrs;
          significantAttrs = this.getSignificantAttributes();
          return significantAttrs.length > 0;
        };

        Block.prototype.hasAnyAttributes = function() {
        ...
        Block.prototype.canBeGrouped = function(depth) {
          var attr, attrs;
          attrs = this.getSignificantAttributes();
          return attr = attrs[depth];
        };
        ...
        Block.prototype.canBeGroupedWith = function(otherBlock, depth) {
          ...
          attribute = this.getSignificantAttributes()[depth];
    ...
    (function() {
      ...
      Trix.HTMLSanitizer = (function(superClass) {
        ...
        DEFAULT_ALLOWED_ATTRIBUTES = "style href src width height class target".split(" ");
    ...
    (function() {
      ...
      Trix.HTMLParser = (function(superClass) {
          ...
          if (nodeIsAttachmentElement(element)) {
            ...
            switch (tagName(element)) {
              case "br":
                ...
                return this.processedElements.push(element);
              case "img":
                if (!Trix.config.attachments.enableImages) {
                  return;
                }
                attributes = {
        ...
        HTMLParser.prototype.getBlockAttributes = function(element) {
          var attribute, attributes, config, ref, ref1;
          attributes = [];
          while (element && element !== this.containerElement) {
            ...
            for (attribute in ref) {
              ...
              if (config.tagNames && (ref1 = tagName(element), indexOf.call(config.tagNames, ref1) >= 0)) {
                if (typeof config.test === "function" ? config.test(element) : void 0) {
                  attributes.push(attribute);
                }
              }
            }
    ...
    (function() {
      ...
      Trix.Document = (function(superClass) {
        ...
        Document.prototype.isEmpty = function() {
          var block;
          return this.blockList.length === 1 && (block = this.getBlockAtIndex(0), block.isEmpty() && !block.hasAnyAttributes());
        };
        ...
        Document.prototype.copyWithBaseBlockAttributes = function(blockAttributes) {
          var attribute, block, blocks, existingBlockAttributes, headers, index, isInsideBlock, newBlockAttributes, newBlockHeaderAttributes, shouldCleanAllHeaderAttrs;
          ...
          blocks = (function() {
            ...
            for (index = i = 0, len = ref.length; i < len; index = ++i) {
              ...
              newBlockAttributes = blockAttributes.filter(function(attr) {
                return indexOf.call(existingBlockAttributes, attr) < 0;
              });
              newBlockHeaderAttributes = (function() {
                var j, len1, results1;
                results1 = [];
                for (j = 0, len1 = newBlockAttributes.length; j < len1; j++) {
                  attribute = newBlockAttributes[j];
                  if (indexOf.call(headers, attribute) >= 0) {
                    results1.push(attribute);
                  }
                }
                return results1;
              })();
              ...
              if (shouldCleanAllHeaderAttrs) {
                existingBlockAttributes = (function() {
                  var j, len1, results1;
                  results1 = [];
                  for (j = 0, len1 = existingBlockAttributes.length; j < len1; j++) {
                    attribute = existingBlockAttributes[j];
                    if (indexOf.call(headers, attribute) < 0) {
                      results1.push(attribute);
                    }
                  }
              ...
              if (index === 0) {
                if (indexOf.call(existingBlockAttributes, "bulletList") >= 0) {
                  isInsideBlock = true;
                }
                results.push(block.copyWithAttributes(newBlockAttributes));
              } else {
                if (isInsideBlock && indexOf.call(existingBlockAttributes, "bulletList") >= 0) {
                  results.push(block.copyWithAttributes(newBlockAttributes));
                } else {
                  isInsideBlock = false;
                  results.push(block);
        ...
        Document.prototype.insertTextAtRange = function(text, range) {
          ...
          return new this.constructor(document.blockList.editObjectAtIndex(index, (function(_this) {
            return function(block) {
              var currentBlockHasNoContentYet, previousBlock, previousBlockAttrs;
              if (index > 0) {
                previousBlock = _this.getBlockAtIndex(index - 1);
              }
              currentBlockHasNoContentYet = block.toString().replace(/\n/g, "") === "";
              if (previousBlock) {
                previousBlockAttrs = previousBlock.attributes;
                if (indexOf.call(previousBlockAttrs, "alignRight") >= 0 && indexOf.call(block.attributes, "alignRight") < 0 && indexOf.call(block.attributes, "alignCenter") < 0) {
                  block = block.addAttribute("alignRight");
                }
                if (indexOf.call(previousBlockAttrs, "alignCenter") >= 0 && indexOf.call(block.attributes, "alignCenter") < 0 && indexOf.call(block.attributes, "alignRight") < 0) {
        ...
        Document.prototype.removeTextAtRange = function(range) {
          var affectedBlockCount, areNotWithinSameBlock, block, blocks, leftBlock, leftBlockStringAtOffsetIsNewLine, leftBlockStringIsNewLine, leftIndex, leftLocation, leftOffset, leftPosition, leftText, ref, ref1, removeLeftNewline, removeRightNewline, removingLeftBlock, rightBlock, rightIndex, rightLocation, rightOffset, rightPosition, rightText, text, useRightBlock, wasCollapsedSelection;
          ...
          if (removeRightNewline) {
            ...
            wasCollapsedSelection = rightPosition - leftPosition === 1;
            leftBlockStringAtOffsetIsNewLine = leftBlock.text.getStringAtPosition(leftOffset) === "\n";
            leftBlockStringIsNewLine = leftBlock.toString().replace(/\n/g, '') === "";
            removeLeftNewline = wasCollapsedSelection && leftBlockStringAtOffsetIsNewLine && leftBlockStringIsNewLine;
            if (removeLeftNewline) {
              block = rightBlock.copyWithText(text);
            } else {
              areNotWithinSameBlock = leftIndex !== rightIndex;
              removingLeftBlock = areNotWithinSameBlock && leftOffset === 0;
        ...
        attributesForBlock = function(block) {
          var attr, attributes, i, len, ref;
          attributes = {};
          ref = block.attributes;
          for (i = 0, len = ref.length; i < len; i++) {
            attr = ref[i];
    ...
    (function() {
      Trix.LineBreakInsertion = (function() {
        ...
        LineBreakInsertion.prototype.shouldBreakFormattedBlock = function() {
          var isEmpty;
          isEmpty = this.block.toString().replace(/\n/g, "") === "";
          return this.block.hasSignificantAttributes() && !this.block.isListItem() && !isEmpty && ((this.breaksOnReturn && this.nextCharacter === "\n") || this.previousCharacter === "\n");
        };
        ...
        LineBreakInsertion.prototype.shouldRemoveLastBlockAttribute = function() {
          return this.block.hasSignificantAttributes() && !this.block.isListItem() && this.block.isEmpty();
        };
    ...
    (function() {
      ...
      Trix.Composition = (function(superClass) {
        ...
        Composition.prototype.insertFiles = function(files) {
          var attachment, attachmentText, attributes, file, i, len, ref, text;
          attributes = this.getCurrentTextAttributes();
          text = new Trix.Text;
          for (i = 0, len = files.length; i < len; i++) {
            file = files[i];
        ...
        Composition.prototype.canSetCurrentBlockAttribute = function(attributeName) {
          var allowedBlockAttrsForTerminalBlocks, block, isAllowed;
          if (!(block = this.getBlock())) {
            return;
          }
          allowedBlockAttrsForTerminalBlocks = ["alignRight", "alignCenter"];
          isAllowed = indexOf.call(allowedBlockAttrsForTerminalBlocks, attributeName) >= 0;
          if (isAllowed) {
            return true;
          } else {
        ...
        Composition.prototype.breakFormattedBlock = function(insertion) {
          var attr, block, blockConfig, document, i, len, newBlock, newDocument, position, previousBlockAttrs, range;
          ...
          for (i = 0, len = previousBlockAttrs.length; i < len; i++) {
            attr = previousBlockAttrs[i];
            blockConfig = getBlockConfig(attr);
            if (blockConfig.inheritFromPreviousBlock && indexOf.call(newBlock.attributes, attr) < 0) {
